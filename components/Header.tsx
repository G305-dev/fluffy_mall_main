  ...
  return (
    <header className="sticky top-0 z-50 border-b border-cream-200 bg-[#fff9f2]/90 backdrop-blur-md">
      ...
      {open &&
        createPortal(
          <div
            className="fixed inset-0 z-[100] bg-cocoa-900/70 lg:hidden"
            role="presentation"
            onClick={() => setOpen(false)}
          >
            <div
              className="h-full w-[90%] max-w-sm overflow-y-auto overscroll-contain border-r-4 border-terracotta-500 bg-cream-50 p-4 shadow-2xl sm:p-5"
              role="dialog"
              aria-modal="true"
            ...
            >
              ...
              <div className="mt-5 grid gap-2 border-t border-cream-200 pt-4 text-base">
                <Link
                  href="/"
                  className="flex items-center gap-2 rounded-xl px-3 py-3 font-medium text-cocoa-800 hover:bg-cream-100"
                >
                  <Home size={17} />
                  Home
                </Link>
                ...
                <Link
                  href="/shop"
                  className="rounded-xl px-3 py-3 font-medium text-cocoa-800 hover:bg-cream-100"
                >
                  All products
                </Link>
                ...
                {authenticated ? (
                  ...
                  <Link
                    href="/login"
                    className="flex items-center gap-2 rounded-xl px-3 py-3 text-cocoa-800 hover:bg-cream-100"
                  >
                    <LogIn size={17} />
                    Sign in
                  </Link>
